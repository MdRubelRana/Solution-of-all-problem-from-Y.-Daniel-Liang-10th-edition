...
/**
 * Chapter 03 Problem 3.32 (Geometry: point position).
 * 
 * Given a directed line from point p0(x0, y0) to p1(x1,y1), 
 * you can use the following condition to decide whether a point p2(x2, y2) is on the left of the line, on the right,
 ...
 * displays whether p2 is on the left of the line from p0 to p1, on the right, or on the same line.
 * 
 */
...
public class PointPosition {
	public static void main(String[] args) {
		...
		if (pointCheck > 0) {
			...
			System.out.println("(" + p2x + ", " + p2y + ") is on the  line from (" + p0x + ", " + p0y + ") to (" + p1x
					+ ", " + p1y + ")");
		} else {
